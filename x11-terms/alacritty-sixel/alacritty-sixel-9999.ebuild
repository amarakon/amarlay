...
DESCRIPTION="GPU-accelerated terminal emulator with SIXEL graphics support"
HOMEPAGE="https://github.com/microo8/alacritty-sixel"

if [ ${PV} == "9999" ] ; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/microo8/alacritty-sixel"
else
